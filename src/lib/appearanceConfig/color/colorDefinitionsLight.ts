...
export const colorDefinitionsLight: ColorDefinitionCategories = {
  ...
  error: {
    ...
    textEmphasis: "text-red-900",
    textPlaceholder: "placeholder:text-red-300",
    fill: "fill-red-800",
    fillOpacity: "fill-red-600/50",
    fillEmphasis: "fill-red-900",
    fillHover: "hover:fill-red-900",
    bg: "bg-red-600",
  ...
  interactive: {
    text: "text-sky-700",
    textOpacity: "text-sky-700/50",
    textHover: "hover:text-sky-800",
    textEmphasis: "text-sky-800",
    textPlaceholder: "placeholder:text-sky-300",
    fill: "fill-sky-700",
    fillOpacity: "fill-sky-700/50",
    fillEmphasis: "fill-sky-800",
    fillHover: "hover:fill-sky-800",
    bg: "bg-sky-700",
    bgOpacity: "bg-sky-700/50",
    bgEmphasis: "bg-sky-800",
